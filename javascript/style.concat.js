...
$(document).ready(function () {
  ...
  $(".skills").waypoint(
    function (direction) {
      ...
      $(".skills__features-responsive").addClass(
        "animation--features animation-delay-200ms"
      );
      $(".skills__features-dynamic").addClass(
        "animation--features animation-delay-400ms"
      );
      $(".skills__features-detail").addClass(
        "animation--features animation-delay-600ms"
      );
    },
    {
      offset: "37%;",
  ...
  $(".skills").waypoint(
    function (direction) {
      ...
      $(".skills__features-responsive-text").addClass(
        "animation--features-text animation-delay-200ms"
      );
      $(".skills__features-dynamic-text").addClass(
        "animation--features-text animation-delay-400ms"
      );
      $(".skills__features-detail-text").addClass(
        "animation--features-text animation-delay-600ms"
      );
    },
    {
      offset: "22%;",
  ...
  $(".skills").waypoint(
    function (direction) {
      ...
      $(".skills__html-fill").addClass(
        "animation--fill-70 animation-delay-1000ms"
      );
      $(".skills__css-fill").addClass(
        "animation--fill-90 animation-delay-1500ms"
      );
      $(".skills__javascript-fill").addClass("animation--fill-70");
      $(".skills__ruby-fill").addClass("animation--fill-50");
      $(".skills__ruby-on-rails-fill").addClass("animation--fill-55");
    },
    {
  ...
  $(".projects").waypoint(
    function (direction) {
      $(".heading-secondary-projects").addClass(
        "animations--heading-secondary"
      );
    },
    {
      offset: "50%;",
